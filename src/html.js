...
export default function initHtml(visualizer) {     
    ...
    document.querySelector("#download").addEventListener("click", () => {
        ...
        setTimeout(() => {
            ...
            let filename = prompt("Please enter the name for the image file:", `bst_${Date.now()}`);
            if (filename) {
    ...
    document.querySelector("#download-txt").addEventListener("click", () => {
        ...
        let filename = prompt("Please enter the name for the text file:", `bst_arrays_${Date.now()}.txt`);
        if (filename) {
    ...
    // Place these event listeners in the initHtml function in html.js
...
document.querySelector("#postorder").addEventListener("click", () => {
    if (!visualizer.tree) return;
    const postOrderArray = BST.postOrderTraversal(visualizer.tree);
